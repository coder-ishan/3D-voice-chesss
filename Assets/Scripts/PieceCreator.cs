...
public class PieceCreator : MonoBehaviour
{
    ...
    private Dictionary<string, GameObject> nameToPieceDict = new Dictionary<string, GameObject>();//to select proper prefab we create a mapping
    ...
    public Material GetTeamMaterial(TeamColor team)
    {
        ...
        //return material depending on parameter
    }
}